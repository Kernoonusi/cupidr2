		...
		<>
			<label
				...
				<input
					...
					className="sr-only"
				/>
				<span className="text-lg font-medium text-gray-700 capitalize group-hover:text-white">Male</span>
			</label>
			...
			<label
				...
				<input
					...
					className="sr-only"
				/>
				<span className="text-lg font-medium text-gray-700 capitalize group-hover:text-white">Female</span>
			</label>
			...
			<label
				...
				<input
					...
					className="sr-only"
				/>
				<span className="text-lg font-medium text-gray-700 capitalize group-hover:text-white">Both</span>
			</label>
		</>
	);
}
